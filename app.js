...
function multiplyArray(testArray){ //eslint-disable-line
  var productArray = multiply(multiply(testArray[0],testArray[1])[0], testArray[2])[0];
  var prodArrayMessage = 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + productArray + '.';
  return [productArray, prodArrayMessage];
}
